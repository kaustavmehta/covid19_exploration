...
setwd("~/Desktop/COVID Research/covid19_exploration_repo/OWiD/")
...
global_covid_data <- read_csv("covid-19-data/public/data/owid-covid-data.csv")
global_covid_data$date <- as.Date(global_covid_data$date, "%d%m%y") #convert dates to a date-readable format

global_testing_data <- read_csv("covid-19-data/public/data/testing/covid-testing-all-observations.csv")
